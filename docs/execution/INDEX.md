...
|---|---|---|---|---|---|
| `revise_R20260611-001_20260611_timing-persistence-resume/` | revise | R20260611-001 / timing-persistence-resume | 実装完了 | 計時状態の永続化・復帰（毎秒localStorage+15秒backend, account-scoped）+ 4H放置キャップ/自動終了 + ログイン遷移終了。167 green、last_saved_at migration 0001 | `INDEX.md` |
