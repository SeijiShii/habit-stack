...
|---|---|---|---|---|---|
| `revise_R20260611-001_20260611_timing-persistence-resume/` | revise | R20260611-001 / timing-persistence-resume | 設計完了 | 計時状態の永続化・復帰（localStorage毎秒+backend15秒, account-scoped）+ 4H放置キャップ/自動終了。真因=復元未配線+定期push不在 | `INDEX.md` |
