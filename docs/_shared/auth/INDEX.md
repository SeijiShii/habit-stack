...
|---|---|---|---|---|---|
| `revise_R20260611-002_20260611_self-service-delete/` | revise | R20260611-002 / self-service-delete | 実装完了→e2e | O54 セルフ削除 UI 導線実装（AccountPage 削除導線 + DELETE /api/account + purgeAllData + wipeOwner outbox 拡張）。176 green。AUDIT_20260611_2000 Critical 起点（「配線待ち」の解消） | `INDEX.md` |
